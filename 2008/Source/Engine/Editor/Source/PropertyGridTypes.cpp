...
WX_PG_IMPLEMENT_VALUE_TYPE_VOIDP(wxVector2f,wxVector2Property,wxVector2f())


class wxVector2PropertyClass : public wxPGPropertyWithChildren
{
  WX_PG_DECLARE_PROPERTY_CLASS()
public:

  wxVector2PropertyClass( const wxString& label,
    const wxString& name,
    const wxVector2f& value );
  virtual ~wxVector2PropertyClass ();
...
WX_PG_IMPLEMENT_PROPERTY_CLASS(wxVector2Property,wxBaseParentProperty,
                               wxVector2f,const wxVector2f&,TextCtrl)


                               wxVector2PropertyClass::wxVector2PropertyClass( const wxString& label,
                               const wxString& name,
                               const wxVector2f& value)
                               : wxPGPropertyWithChildren(label,name)
{
  wxPG_INIT_REQUIRED_TYPE(wxVector2f)
    DoSetValue((void*)&value);
  AddChild( wxFloatProperty(wxT("X"),wxPG_LABEL,value.x) );
  AddChild( wxFloatProperty(wxT("Y"),wxPG_LABEL,value.y) );
}

wxVector2PropertyClass::~wxVector2PropertyClass() { }

void wxVector2PropertyClass::DoSetValue( wxPGVariant value )
{
  wxVector2f* pObj = (wxVector2f*)wxPGVariantToVoidPtr(value);
  m_value = *pObj;
  RefreshChildren();
}

wxPGVariant wxVector2PropertyClass::DoGetValue() const
{
  return wxPGVariant((void*)&m_value);
}

void wxVector2PropertyClass::RefreshChildren()
{
  if ( !GetCount() ) return;
...
void wxVector2PropertyClass::ChildChanged( wxPGProperty* p )
{
  switch ( p->GetIndexInParent() )
  {
...
WX_PG_IMPLEMENT_VALUE_TYPE_VOIDP(wxVector3f,wxVector3Property,wxVector3f())


class wxVector3PropertyClass : public wxPGPropertyWithChildren
{
  WX_PG_DECLARE_PROPERTY_CLASS()
public:

  wxVector3PropertyClass( const wxString& label,
    const wxString& name,
    const wxVector3f& value );
  virtual ~wxVector3PropertyClass ();
...
WX_PG_IMPLEMENT_PROPERTY_CLASS(wxVector3Property,wxBaseParentProperty,
                               wxVector3f,const wxVector3f&,TextCtrl)


                               wxVector3PropertyClass::wxVector3PropertyClass( const wxString& label,
                               const wxString& name,
                               const wxVector3f& value)
                               : wxPGPropertyWithChildren(label,name)
{
...
wxVector3PropertyClass::~wxVector3PropertyClass() { }

void wxVector3PropertyClass::DoSetValue( wxPGVariant value )
{
...
wxPGVariant wxVector3PropertyClass::DoGetValue() const
{
  return wxPGVariant((void*)&m_value);
}

void wxVector3PropertyClass::RefreshChildren()
{
  if ( !GetCount() ) return;
  Item(0)->DoSetValue( m_value.x );
  Item(1)->DoSetValue( m_value.y );
...
void wxVector3PropertyClass::ChildChanged( wxPGProperty* p )
{
  switch ( p->GetIndexInParent() )
  {
  case 0: m_value.x = p->DoGetValue().GetDouble(); break;
...
WX_PG_IMPLEMENT_VALUE_TYPE_VOIDP(wxVector4f,wxVector4Property,wxVector4f())


class wxVector4PropertyClass : public wxPGPropertyWithChildren
{
  WX_PG_DECLARE_PROPERTY_CLASS()
public:

  wxVector4PropertyClass( const wxString& label,
    const wxString& name,
    const wxVector4f& value );
  virtual ~wxVector4PropertyClass ();
...
WX_PG_IMPLEMENT_PROPERTY_CLASS(wxVector4Property,wxBaseParentProperty,
                               wxVector4f,const wxVector4f&,TextCtrl)


                               wxVector4PropertyClass::wxVector4PropertyClass( const wxString& label,
                               const wxString& name,
                               const wxVector4f& value)
                               : wxPGPropertyWithChildren(label,name)
{
  wxPG_INIT_REQUIRED_TYPE(wxVector4f)
    DoSetValue((void*)&value);
  AddChild( wxFloatProperty(wxT("X"),wxPG_LABEL,value.x) );
  AddChild( wxFloatProperty(wxT("Y"),wxPG_LABEL,value.y) );
  AddChild( wxFloatProperty(wxT("Z"),wxPG_LABEL,value.z) );
  AddChild( wxFloatProperty(wxT("W"),wxPG_LABEL,value.w) );
}

wxVector4PropertyClass::~wxVector4PropertyClass() { }

void wxVector4PropertyClass::DoSetValue( wxPGVariant value )
{
  wxVector4f* pObj = (wxVector4f*)wxPGVariantToVoidPtr(value);
  m_value = *pObj;
  RefreshChildren();
}

wxPGVariant wxVector4PropertyClass::DoGetValue() const
{
  return wxPGVariant((void*)&m_value);
}

void wxVector4PropertyClass::RefreshChildren()
{
  if ( !GetCount() ) return;
  Item(0)->DoSetValue( m_value.x );
  Item(1)->DoSetValue( m_value.y );
  Item(2)->DoSetValue( m_value.z );
  Item(3)->DoSetValue( m_value.w );
}

void wxVector4PropertyClass::ChildChanged( wxPGProperty* p )
{
  switch ( p->GetIndexInParent() )
  {
  case 0: m_value.x = p->DoGetValue().GetDouble(); break;
  case 1: m_value.y = p->DoGetValue().GetDouble(); break;
  case 2: m_value.z = p->DoGetValue().GetDouble(); break;
  case 3: m_value.w = p->DoGetValue().GetDouble(); break;
  }
}
