...
#ifdef _DEBUG
#ifdef TOOLS
#pragma comment (lib, "Editor-Tools_d.lib")
#else // !TOOLS
#pragma comment (lib, "Editor_d.lib")
#endif // !TOOLS
#else // !_DEBUG
#ifdef TOOLS
#pragma comment (lib, "Editor-Tools.lib")
#else // !TOOLS
#ifdef FINAL_RELEASE
#pragma comment (lib, "Editor-Final.lib")
#else // !FINAL_RELEASE
