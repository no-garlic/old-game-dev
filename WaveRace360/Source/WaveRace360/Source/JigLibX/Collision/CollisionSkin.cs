...
namespace JigLibX.Collision
{
    ...
    public class CollisionSkin
    {
        ...
        private List<MaterialProperties> materialProperties = new List<MaterialProperties>();   // values used when mat ID is USER_DEFINED
...
// BEGIN_CHANGE
        ...
        public ulong BitFlags = 0x00000000;
// END_CHANGE
...
// BEGIN_CHANGE
//              return true;
                return (skin0.BitFlags == 0) ||                   // No flags set - collides with all
                       (skin1.BitFlags == 0) ||                   // No flags set - collides with all
                       ((skin0.BitFlags & skin1.BitFlags) != 0);  // Check that there is atleast 1 common flag
// END_CHANGE
            }
        }
        ...
        public bool SegmentIntersect(out float frac, out Vector3 pos, out Vector3 normal, Segment seg)
        {
            ...
            for (int prim = primitivesNewWorld.Count; prim-- != 0; )
            {
                ...
                if (primitivesNewWorld[prim].SegmentIntersect(out thisFrac, out pos, out normal, segCopy))
                {
