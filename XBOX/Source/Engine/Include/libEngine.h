...
#pragma comment (lib, "Framework-Tools_d.lib")
#pragma comment (lib, "ODE-Tools_d.lib")
#else // !TOOLS
...
#pragma comment (lib, "Framework-Tools.lib")
#pragma comment (lib, "ODE-Tools.lib")
#else // !TOOLS
...
#pragma comment (lib, "Framework-Final.lib")
#pragma comment (lib, "ODE-Final.lib")
#else // !FINAL_RELEASE
