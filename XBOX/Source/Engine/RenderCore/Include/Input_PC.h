...
#ifndef __INPUT_PC_H_
#define __INPUT_PC_H_
...
// ----------------------------------------------------------------------------
class Input_PC : public BaseInput
{
public:
  // --------------------------------------------------------------------------
  // Singleton
  // --------------------------------------------------------------------------
  static Input_PC &GetInstance();
  ...
  // Key conversions
  // --------------------------------------------------------------------------
  bool IsNumber(KeyParam key);
  bool IsText(KeyParam key);
  bool IsSymbol(KeyParam key);
  bool IsPrintable(KeyParam key);
  char ToChar(KeyParam key);
...
private:
  ...
  XINPUT_GAMEPAD              m_GamepadData;            // Stored Gamepad data
  ...
  Queue<MouseMessage>         m_MouseMessageQueue;      // Queue of mouse messages
  Queue<KeyboardMessage>      m_KeyboardMessageQueue;   // Queue of key messages
  Queue<GamepadMessage>       m_GamepadMessageQueue;    // Queue of gamepad messages
  static Input_PC            *s_pInstance;              // Singelton instance
