...
/*
std::vector<TexMap>& CalCoreMaterial_GetVectorMap(CalCoreMaterial *self)
{
...
/*
Boolean CalCoreMaterial_SetMap(CalCoreMaterial *self, int mapId, CalCoreMaterial::TexMap *pMap)
{
