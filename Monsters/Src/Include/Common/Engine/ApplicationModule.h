...
public:
  ...
  virtual bool CreateSafeObjects()    = 0;
  virtual bool CreateDeviceObjects()  = 0;
  virtual bool ReleaseSafeObjects()   = 0;
  virtual bool ReleaseDeviceObjects() = 0;
...
// ----------------------------------------------------------------------------
#define REGISTER_MODULE(x) namespace { ApplicationModuleManager::CreationFunctor<x> g_ModuleReg(#x); };
...
public:
  ...
  struct BaseCreationFunctor
  {
    ...
    // ------------------------------------------------------------------------
    virtual ApplicationModule *Create() = 0;
  ...
  struct CreationFunctor : public BaseCreationFunctor
  {
    ...
    // Create the module instance
    // ------------------------------------------------------------------------
    virtual ApplicationModule *Create()
    {
      return new T;
    }; // Create
